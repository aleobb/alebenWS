...
int main(void)
{
    ...
    while(opcion!=SALIR)
    {
        ...
        switch(opcion)
        {
            ...
            /// listarDestinatariosFiltrados(listaDestinatarios, listaNegra, compararDestinatario, 1);
                listarDestinatariosFiltrados(listaDestinatarios, listaNegra, compararDestinatarioPorMail, 1);
                break;
            case SALIR:
                printf("\n\n PROCESO TERMINADO. \n");
                break;
